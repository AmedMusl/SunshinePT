...
function onClear(slot_data)
    ...
    -- sanities
    if slot_data['hundredcoins'] then
        local coinsanity = Tracker:FindObjectForCode("coin_shine_enabled")
        coinsanity.Active = (slot_data['hundredcoins'])
    end

    if slot_data['bluecoinsanity'] then
        local bluesanity = Tracker:FindObjectForCode("blues")
        bluesanity.Active = (slot_data['bluecoinsanity'])
    end

    if slot_data['boatcoinsonly'] then
        local boat = Tracker:FindObjectForCode("boathouse")
        boat.Active = (slot_data['boatcoinsonly'])
    end
